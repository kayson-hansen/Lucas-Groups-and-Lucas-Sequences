...
given values for the parameters P, p, and D, and testing if an element is a generator of a Lucas Group. 
"""
...
#implements the Strong Lucas Pseudoprime test (this has already been discovered)
def strong_test(n, P):
